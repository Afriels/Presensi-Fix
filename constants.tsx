...
export const SchoolIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14 22v-4a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v4"/><path d="M18 10h4v12h-4V10z"/><path d="m22 10-10-7-10 7"/><path d="M2 10h20"/></svg>
);
...
// FIX: Add missing DownloadIcon for use in StudentData.tsx
...
// FIX: Add missing IdCardIcon for use in StudentData.tsx
export const IdCardIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect width="20" height="16" x="2" y="4" rx="2"/><path d="M6 10h2"/><path d="M12 10h6"/><path d="M6 14h2"/><path d="M12 14h4"/></svg>
);
