...
export const SchoolIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14 22v-4a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v4" /><path d="M18 10h4" /><path d="M18 18h4" /><path d="M2 22h12" /><path d="M2 18h12" /><path d="M2 14h12" /><path d="M2 10h12" /><path d="M18 6h4" /><path d="M2 6h12" /><path d="m22 6-4-4-4 4" /><path d="m18 18-4 4-4-4" /></svg>
);

export const NAV_LINKS = [
    { name: 'Dashboard', href: '/dashboard', icon: HomeIcon },
    { name: 'Absensi Barcode', href: '/scan', icon: BarcodeIcon },
    { name: 'Laporan Harian', href: '/laporan-harian', icon: CalendarIcon },
    { name: 'Rekap Bulanan', href: '/laporan-bulanan', icon: FileTextIcon },
    { name: 'Input Manual', href: '/input-manual', icon: EditIcon },
    { name: 'Data Siswa', href: '/data-siswa', icon: UsersIcon },
    { name: 'Pengaturan', href: '/pengaturan', icon: SettingsIcon },
];

// Placeholder sound files for notifications
export const SOUNDS = {
