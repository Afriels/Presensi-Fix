                ...
                <div className="border-t pt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                        <div>
                            ...
                            <input type="file" accept="image/png" onChange={(e) => handleFileChange(e, 'signature')} className="mt-2 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-primary-50 file:text-primary-700 hover:file:bg-primary-100" disabled={user?.role !== 'admin'} />
                        </div>
                        <div>
                            ...
                            <input type="file" accept="image/png" onChange={(e) => handleFileChange(e, 'stamp')} className="mt-2 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-primary-50 file:text-primary-700 hover:file:bg-primary-100" disabled={user?.role !== 'admin'} />
                        </div>
                    </div>
                </div>
